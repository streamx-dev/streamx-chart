# StreamX Helm Chart
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) ![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.5-jvm](https://img.shields.io/badge/AppVersion-0.0.5--jvm-informational?style=flat-square)
...
1. Create secret for Rest Ingrestion Auth:
   ...
   kubectl apply -f examples/reference/secrets/restIngestionJwtKeys.yaml
   ```
   ...
   kubectl create namespace streamx || true
   kubectl -n streamx create secret generic streamx-api-keys --from-file=./privateKey.pem --from-file=./publicKey.pub
   ```
   </p>
   </details>
